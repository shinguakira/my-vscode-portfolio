...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  {
    id: "file-about",
    targetSelector: "[data-tutorial='file-about.ts']",
    title: "プロフィール",
    description: "about.tsには自己紹介が記載されています。",
    position: "right",
    mobilePosition: "bottom",
    uiState: { sidebarMode: "explorer", sidebarCollapsed: false },
  },
  {
    ...
    title: "ファイル内容",
    description: "TypeScript形式で自己紹介が表示されます。",
    position: "bottom",
    mobilePosition: "top",
    uiState: { sidebarMode: "explorer", sidebarCollapsed: false },
    action: { type: "openFile", payload: "about.ts" },
  },
  {
    id: "preview-button",
  ...
  },
  {
    ...
    mobilePosition: "top",
    uiState: { sidebarMode: "extensions", sidebarCollapsed: false },
    action: { type: "openExtension", payload: "0" },
  },
  {
    id: "terminal-intro",
...
export const TUTORIAL_STEPS_EN: TutorialStep[] = [
  ...
  },
  {
    ...
    targetSelector: "[data-tutorial='file-about.ts']",
    title: "About",
    description: "about.ts contains the self-introduction.",
    position: "right",
    mobilePosition: "bottom",
    uiState: { sidebarMode: "explorer", sidebarCollapsed: false },
  },
  {
    ...
    targetSelector: "[data-tutorial='editor-area']",
    title: "File Contents",
    description: "The self-introduction is displayed in TypeScript format.",
    position: "bottom",
    mobilePosition: "top",
    uiState: { sidebarMode: "explorer", sidebarCollapsed: false },
    action: { type: "openFile", payload: "about.ts" },
