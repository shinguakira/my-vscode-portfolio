...
export function PreviewPanel({ fileName, content, theme = "modern" }: PreviewPanelProps) {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4">
      <div className="max-w-full mx-auto p-4 bg-slate-900/50 border border-slate-800 backdrop-blur rounded-xl shadow-sm">
