            ...
            return (
              ...
              >
                ...
                <div className="relative bg-black border border-gray-800 rounded-2xl p-6 short:p-3 flex items-center gap-4 short:gap-3">
                  <div
                    className={`w-14 h-14 short:w-10 short:h-10 rounded-xl bg-gradient-to-r ${gradient} flex items-center justify-center text-white shrink-0`}
                  >
                    <Icon className="w-7 h-7" />
                  </div>
                  <div className="min-w-0">
                    <div className="text-gray-500 text-sm mb-0.5">{label}</div>
                    <div className="text-base short:text-sm font-bold text-white truncate">
                      {value}
                    </div>
                  </div>
                </div>
          ...
          <div className="relative bg-black border border-gray-800 rounded-2xl p-5 short:p-2">
            {sent ? (
              <div className="text-center py-10">
                ...
                <button
                  onClick={reset}
                  className="px-8 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white font-bold hover:bg-gray-800 transition"
                >
                  {t.another}
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-gray-950 border border-gray-800 text-white focus:border-pink-500 focus:outline-none transition"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-950 border border-gray-800 text-white focus:border-pink-500 focus:outline-none transition resize-none"
                  />
                </div>
                {formError && (
                ...
                <div className="text-center">
                  <div className="inline-block group/btn relative">
                    ...
                    <button
                      type="submit"
                      disabled={sending}
                      className="relative flex items-center gap-2 px-12 py-4 bg-black rounded-xl text-white font-bold text-lg disabled:opacity-50"
                    >
